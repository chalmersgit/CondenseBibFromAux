...
def generateBib(bibDict,citationLabels, outputFn='_outputbib.bib'):
	f = open(outputFn, "w") 
	f.write("%% This BibTeX bibliography file was generated by condenseBibtex.py.\n\n")
	for label in citationLabels:
		f.write(bibDict[label])
		f.write('\n\n')
	f.close()

def condenseBibtex(bibFile, auxFile, outputFn='_outputbib.bib'):
...
if __name__ == "__main__":
	...
	condenseBibtex(args.bib, args.aux, args.output)
